...
bot = telebot.TeleBot('7865126082:AAHMVgL7otLtIvOQRPCkeC92xdNlBQoOYuE')
...
# Function to calculate remaining approval timeni 
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM TO BUY ACCESS:- @HAT_BUG_VISHU")
...
Buy From :- @HAT_BUG_VISHU
Official Channel :- NOT FOUND
'''
